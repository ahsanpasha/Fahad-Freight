...
const steps = [
  {
    ...
    step: "01",
    title: "Book & Plan",
    desc: "Submit your shipment details online or via our team. We plan the optimal route, carrier, and timeline for your cargo.",
  ...
  },
  {
    ...
    step: "02",
    title: "Ship & Track",
    desc: "Your goods move through our global network with real-time GPS tracking, automated updates, and 24/7 support.",
  ...
  },
  {
    ...
    desc: "Safe, on-time delivery with proof-of-delivery, customs clearance, and full documentation — every time.",
    color: "from-primary to-orange-glow",
  },
];
